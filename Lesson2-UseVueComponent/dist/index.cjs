...
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("path", { d: "m325.606 229.393-150.004-150a14.997 14.997 0 0 0-21.213.001l-149.996 150c-5.858 5.858-5.858 15.355 0 21.213 5.857 5.857 15.355 5.858 21.213 0l139.39-139.393 139.397 139.393A14.953 14.953 0 0 0 315 255a14.95 14.95 0 0 0 10.607-4.394c5.857-5.858 5.857-15.355-.001-21.213z" }, null, -1);
const _hoisted_4 = [
  _hoisted_3
];
const _hoisted_5 = {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return showArrows.value ? (openBlock(), createElementBlock("div", _hoisted_1$2, [
        showUp.value ? (openBlock(), createElementBlock("svg", _hoisted_2, _hoisted_4)) : (openBlock(), createElementBlock("svg", _hoisted_5, _hoisted_7))
      ])) : createCommentVNode("", true);
    };
  }
});

const _hoisted_1$1 = { class: "price-info" };
      ...
      return openBlock(), createBlock(Transition, { mode: "out-in" }, {
        default: withCtx(() => [
          (openBlock(), createElementBlock("div", {
            class: "inner",
            key: unref(coin).formatted
          }, [
            createTextVNode(toDisplayString(unref(coin).name) + " ", 1),
            createBaseVNode("div", _hoisted_1$1, [
              createBaseVNode("span", null, toDisplayString(unref(coin).formatted), 1),
              createVNode(_sfc_main$2, {
                name: unref(coin).name,
                amount: unref(coin).money
              }, null, 8, ["name", "amount"])
            ])
          ]))
        ]),
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const setValues = async () => {
      ...
      date.value = (/* @__PURE__ */ new Date()).toString();
      if (props.pair) {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createBaseVNode("section", null, [
          createVNode(_sfc_main$1, {
            coin: btc,
            style: normalizeStyle("background-color:" + _ctx.background)
          }, null, 8, ["coin", "style"]),
          createVNode(_sfc_main$1, {
            coin: eth,
            style: normalizeStyle("background-color:" + _ctx.background)
          }, null, 8, ["coin", "style"]),
          _ctx.pair ? (openBlock(), createBlock(_sfc_main$1, {
            key: 0,
            coin: pairData,
            style: normalizeStyle("background-color:" + _ctx.background)
          }, null, 8, ["coin", "style"])) : createCommentVNode("", true)
        ]),
...
const VueCoinTracker = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]]]);

const CoinTracker = defineCustomElement(VueCoinTracker);
function register(tagName = 'coin-tracker') {
  customElements.define(tagName, CoinTracker);
}

exports.CoinTracker = CoinTracker;
